...
var forms = function forms() {
  ...
  inputs = document.querySelectorAll('input'),
      upload = document.querySelectorAll('[name="upload"]'); // обработка ввода данных(чтобы пользователь мог ввести в инпут телефона только цифры)
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      postDate(api, formDate) // сейчас вернулся какой-то текст return await res.text()
      .then(function (res) {
        console.log(res);
